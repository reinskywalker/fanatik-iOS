//
//  TimelinePlaylistTableViewCell.m
//  Fanatik
//
...
@implementation TimelinePlaylistTableViewCell
...
-(void)setItemWithPlayList:(Playlist *)pl{
    ...
    playlistVideoCountLabel.text = [NSString stringWithFormat:@"%lu video%@", (unsigned long)self.clipsArray.count, self.clipsArray.count>1?@"s":@""];
