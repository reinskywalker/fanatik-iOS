...
@interface VideoDetailViewController ()<VideoInfoTableViewCellDelegate, IBActionSheetDelegate, UIActionSheetDelegate, SearchClipTableViewCellDelegate, UIGestureRecognizerDelegate, DMMoviePlayerDelegate>
...
@synthesize userAutoCompleteArray, playerView, heightKeyboardViewConstraint, youtubePlayerTopConstraint;
...
-(void)configureView{
    ...
    youtubePlayerTopConstraint = [youtubePlayer sdc_alignEdge:UIRectEdgeTop withEdge:UIRectEdgeTop ofView:self.view inset:64.0];
    [youtubePlayer sdc_alignEdge:UIRectEdgeLeft withEdge:UIRectEdgeLeft ofView:self.view];
    [youtubePlayer sdc_alignEdge:UIRectEdgeRight withEdge:UIRectEdgeRight ofView:self.view];
    NSLayoutConstraint *constraint =[NSLayoutConstraint
                                     constraintWithItem:youtubePlayer
                                     attribute:NSLayoutAttributeWidth
                                     relatedBy:NSLayoutRelationEqual
                                     toItem:youtubePlayer
                                     attribute:NSLayoutAttributeHeight
                                     multiplier:16.0/9.0 //Aspect ratio: 4*height = 3*width
                                     constant:0.0f];
    [youtubePlayer addConstraint:constraint];
...
-(void)reloadVideo{
    ...
    if([self.currentClip.clip_video.video_type isEqualToString:@"Youtube"]){
        ...
        NSURL *thumbnailURL = [NSURL URLWithString:currentClip.clip_video.video_thumbnail.thumbnail_480];
        NSURL *videoURL = [NSURL URLWithString:self.currentClip.clip_video.video_hls.hls_url];
        ...
        NSLog(@"Content Video URL : %@", self.playerView.contentURL);
...
-(void)willRotateToInterfaceOrientation:(UIInterfaceOrientation)toInterfaceOrientation duration:(NSTimeInterval)duration{
    ...
    if(toInterfaceOrientation == UIInterfaceOrientationLandscapeLeft || toInterfaceOrientation == UIInterfaceOrientationLandscapeRight){
        ...
        self.youtubePlayerTopConstraint.constant = 0.0;
        ...
        self.youtubePlayerTopConstraint.constant = 64.0;
    }
