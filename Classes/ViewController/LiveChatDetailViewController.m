...
@interface LiveChatDetailViewController ()<DMMoviePlayerDelegate, DMChatViewDelegate>
...
-(void)viewWillAppear:(BOOL)animated{
    self.pageObjectName = self.currentBroadcaster.broadon_title;
...
- (void)viewDidLoad {
    ...
    self.title = currentBroadcaster.broadon_title;
    self.currentPageCode = MenuPageLiveChatDetail;
    
    NSURL *thumbnailURL = [NSURL URLWithString:currentBroadcaster.broadon_banner_url];
    NSURL *videoURL = [NSURL URLWithString:currentBroadcaster.broadon_streaming_url];
...
-(void)handshakeWebSocket{
    ...
    NSMutableDictionary *dict = [NSMutableDictionary dictionaryWithObjectsAndKeys:
                                 ...
                                 currentBroadcaster.broadon_user_id, @"broadcasterId",
                                 self.visitorId, @"id",
