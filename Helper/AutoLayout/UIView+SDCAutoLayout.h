...
- (NSLayoutConstraint *)sdc_pinWidthToWidthOfView:(UIView *)view multiplier:(CGFloat)multiplier;
...
- (NSLayoutConstraint *)sdc_pinHeightToHeightOfView:(UIView *)view multiplier:(CGFloat)multiplier;
